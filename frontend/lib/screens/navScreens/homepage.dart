...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  String selectedShape = 'freehand'; // freehand, line, rectangle, circle
  DrawingPoint? startPoint;
  Offset? currentDragPosition; // Add this to track current drag
  bool isFillMode = false;  // Add this line
  List<DrawingPoint?> redoStack = [];  // Add this line
  ...
  void initState() {
    ...
    _menuSlideAnimation = Tween<double>(
      begin: 200, // Changed from -200 to 200 for vertical animation
      end: 0,
